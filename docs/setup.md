...
You'll notice that "matrix-bob" is scattered throughout the codebase. When
it comes time to modifying the code for your own purposes, you are expected to
replace every instance of "matrix-bob" and its variances with your own
project's name.
